...
\section*{Analysis: Analysis of Water Quality Components and Limitations}
...
ggplot() +
  ...
  labs(title = "Eutrophication Risk Across Monitoring Stations",
       color = "Eutrophication Risk Type") +
  theme_classic() + 
  theme(plot.title = element_text(size = 14, face = "bold", hjust = 0.5),axis.text.x = element_blank(),
