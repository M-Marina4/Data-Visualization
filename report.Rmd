...
\section*{Analysis: Eutrophication risk across station}
...
```{r, echo=FALSE, message=FALSE, warning=FALSE}
# Merge the data with stations to have the coordinates for further visualization on the map
...
\section*{Analysis: Pollution Dynamics and Dissolved Oxygen Trend}
